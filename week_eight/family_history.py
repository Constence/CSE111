...
def print_death_age(people_dict):
    ...
    for person_key, death_list in people_dict.items():
        ...
        person_death = death_list[DEATH_YEAR_INDEX]
        person_born = death_list[BIRTH_YEAR_INDEX]
        person_age =person_death - person_born
...
def count_genders(people_dict):
    ...
    male = 0
    women = 0 
    for person_key, gender_list in people_dict.items():
    ...
    print(f"There are {male} males and {women} females")
pass 
...
WEDDING_YEAR_INDEX = 2
    ...
    for person_key, marriages in marriages_dict.items():
        ...
        print(f"The husband is named{husband_name}, he is {husband_age_two} years old and was married on {wedding}")
        print(f"The Wife is named{wife_name}, she is {wife_age_two} years old and was married on {wedding}")
