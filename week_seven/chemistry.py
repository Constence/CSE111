def main(): 
    ...
    chem_formula = input("What is a chemical formula you want to test? ").upper()

    #def parse_formula(formula, periodic_table_dict):

    # Get the mass of a chemical sample in grams from the user.
    
    mass_user = float(input("What is the mass of the chemical sample in grams that you want? "))

    # Call the make_periodic_table function and
    # store the periodic table in a variable.

    Ver_periodic_table = make_periodic_table() 
    ...
    symbol_quantity_list = parse_formula(chem_formula, Ver_periodic_table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.

    molar_mass = compute_molar_mass(symbol_quantity_list, Ver_periodic_table)

    # Compute the number of moles in the sample.
    num_moles = mass_user/molar_mass
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for elements in symbol_quantity_list:
        ...
        quan = elements[QUANTITY_INDEX]
        # Get the atomic mass for the symbol from the dictionary.
        mas_sym = periodic_table_dict[symbol][ATOMIC_MASS_INDEX]
    
        # Multiply the atomic mass by the quantity.
        
        new_mass += mas_sym * quan
